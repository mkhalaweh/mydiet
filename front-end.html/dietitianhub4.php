...
<?php 
   ...
   $result = mysqli_query($conn, $sql);
     ...
     <br><br><br><br>
     <tr>
     <th class="tblcell2">Waiting List</th>
   ...
   while($info = mysqli_fetch_assoc($result)){
    ...
    <th><a href="dietitianhubs.php?statusr=<?php echo $info['senderu'] ?>" style="text-decoration: none"><button id="logoutbtn">Details</button></a></th>
    <?php
    echo "</tr>"; 
	}
    ?>
