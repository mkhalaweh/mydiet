...
$username = $_GET['replyu'];

$sql = "SELECT * FROM info WHERE senderu = '$username'";
$result = mysqli_query($conn, $sql);
$check = mysqli_num_rows($result);

if($check < 1){
  
  header("Location: dietitianhub2.php");
  exit();
...
<!-- replying system -->
 <body>
  ...
  <div class="columnmsg">
  	<div class="box2">
  		<h1 class=credentials_text>Reply to the User</h1>
  		<br><br<br><br><br>
  	<form action="../back-end.php/replyback.php" method="POST">
      
    <p class="credentials_text2">Customer: &nbsp; </p><input readonly name="reciever" type="text" class="credentials3" value= <?php echo $_GET['replyu']; ?>>
    <br>
